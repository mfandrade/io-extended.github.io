...
module.exports=require('sKNqbK');
},{}],"sKNqbK":[function(require,module,exports){
...
},{"events":1,"components/styler":"HO8eEg"}],"components/slide-number":[function(require,module,exports){
module.exports=require('7IOt/m');
},{}],"7IOt/m":[function(require,module,exports){
...
function SlideNumberViewModel (slide, slideshow) {
  ...
  self.element.className = 'pr-slide-number';
...
window.PitchRocksEngine = window.remark = new Api();
...
},{"components/styler":"HO8eEg","./remark/api":4,"./polyfills":5}],"components/styler":[function(require,module,exports){
module.exports=require('HO8eEg');
},{}],"HO8eEg":[function(require,module,exports){
...
module.exports=require('9cgzCl');
},{}],"9cgzCl":[function(require,module,exports){
...
module.exports = {
  documentStyles: "html.pr-container,body.pr-container{height:100%;width:100%;-webkit-print-color-adjust:exact;}.pr-container{background:#d7d8d2;margin:0;overflow:hidden;}.pr-container:focus{outline-style:solid;outline-width:1px;}:-webkit-full-screen .pr-container{width:100%;height:100%;}.pr-slides-area{position:relative;height:100%;width:100%;}.pr-slide-container{display:none;position:absolute;height:100%;width:100%;page-break-after:always;}.pr-slide-scaler{background-color:transparent;overflow:hidden;position:absolute;-webkit-transform-origin:top left;-moz-transform-origin:top left;transform-origin:top-left;-moz-box-shadow:0 0 30px #888;-webkit-box-shadow:0 0 30px #888;box-shadow:0 0 30px #888;}.pr-slide{height:100%;width:100%;display:table;table-layout:fixed;}.pr-slide>.left{text-align:left;}.pr-slide>.center{text-align:center;}.pr-slide>.right{text-align:right;}.pr-slide>.top{vertical-align:top;}.pr-slide>.middle{vertical-align:middle;}.pr-slide>.bottom{vertical-align:bottom;}.pr-slide-content{background-color:#fff;background-position:center;background-repeat:no-repeat;display:table-cell;font-size:20px;padding:1em 4em 1em 4em;}.pr-slide-content h1{font-size:55px;}.pr-slide-content h2{font-size:45px;}.pr-slide-content h3{font-size:35px;}.pr-slide-content .left{display:block;text-align:left;}.pr-slide-content .center{display:block;text-align:center;}.pr-slide-content .right{display:block;text-align:right;}.pr-slide-number{bottom:12px;opacity:0.5;position:absolute;right:20px;}.pr-slide-notes{border-top:3px solid black;position:absolute;display:none;}.pr-code{font-size:18px;}.pr-code-line{min-height:1em;}.pr-code-line-highlighted{background-color:rgba(255, 255, 0, 0.5);}.pr-code-span-highlighted{background-color:rgba(255, 255, 0, 0.5);padding:1px 2px 2px 2px;}.pr-visible{display:block;z-index:2;}.pr-fading{display:block;z-index:1;}.pr-fading .pr-slide-scaler{-moz-box-shadow:none;-webkit-box-shadow:none;box-shadow:none;}.pr-backdrop{position:absolute;top:0;bottom:0;left:0;right:0;display:none;background:#000;z-index:2;}.pr-pause{bottom:0;top:0;right:0;left:0;display:none;position:absolute;z-index:1000;}.pr-pause .pr-pause-lozenge{margin-top:30%;text-align:center;}.pr-pause .pr-pause-lozenge span{color:white;background:black;border:2px solid black;border-radius:20px;padding:20px 30px;font-family:Helvetica,arial,freesans,clean,sans-serif;font-size:42pt;font-weight:bold;}.pr-container.pr-presenter-mode.pr-pause-mode .pr-pause{display:block;}.pr-container.pr-presenter-mode.pr-pause-mode .pr-backdrop{display:block;opacity:0.5;}.pr-help{bottom:0;top:0;right:0;left:0;display:none;position:absolute;z-index:1000;-webkit-transform-origin:top left;-moz-transform-origin:top left;transform-origin:top-left;}.pr-help .pr-help-content{color:white;font-family:Helvetica,arial,freesans,clean,sans-serif;font-size:12pt;position:absolute;top:5%;bottom:10%;height:10%;left:5%;width:90%;}.pr-help .pr-help-content h1{font-size:36px;}.pr-help .pr-help-content td{color:white;font-size:12pt;padding:10px;}.pr-help .pr-help-content td:first-child{padding-left:0;}.pr-help .pr-help-content .key{background:white;color:black;min-width:1em;display:inline-block;padding:3px 6px;text-align:center;border-radius:4px;font-size:14px;}.pr-help .dismiss{top:85%;}.pr-container.pr-help-mode .pr-help{display:block;}.pr-container.pr-help-mode .pr-backdrop{display:block;opacity:0.95;}.pr-preview-area{bottom:2%;left:2%;display:none;opacity:0.5;position:absolute;height:47.25%;width:48%;}.pr-preview-area .pr-slide-container{display:block;}.pr-notes-area{background:#e7e8e2;bottom:0;display:none;left:52%;overflow:hidden;position:absolute;right:0;top:0;}.pr-notes-area .pr-top-area{height:50px;left:20px;position:absolute;right:10px;top:10px;}.pr-notes-area .pr-bottom-area{position:absolute;top:75px;bottom:10px;left:20px;right:10px;}.pr-notes-area .pr-bottom-area .pr-toggle{display:block;text-decoration:none;font-family:Helvetica,arial,freesans,clean,sans-serif;border-bottom:1px solid #ccc;height:21px;font-size:0.75em;font-weight:bold;text-transform:uppercase;color:#666;text-shadow:#f5f5f5 1px 1px 1px;}.pr-notes-area .pr-bottom-area .pr-notes-current-area{height:70%;position:relative;}.pr-notes-area .pr-bottom-area .pr-notes-current-area .pr-notes{clear:both;border-top:1px solid #f5f5f5;position:absolute;top:22px;bottom:0px;left:0px;right:0px;overflow-y:auto;margin-bottom:20px;}.pr-notes-area .pr-bottom-area .pr-notes-preview-area{height:30%;position:relative;}.pr-notes-area .pr-bottom-area .pr-notes-preview-area .pr-notes-preview{border-top:1px solid #f5f5f5;position:absolute;top:22px;bottom:0px;left:0px;right:0px;overflow-y:auto;}.pr-notes-area .pr-bottom-area .pr-notes>*:first-child,.pr-notes-area .pr-bottom-area .pr-notes-preview>*:first-child{margin-top:5px;}.pr-notes-area .pr-bottom-area .pr-notes>*:last-child,.pr-notes-area .pr-bottom-area .pr-notes-preview>*:last-child{margin-bottom:0;}.pr-toolbar{color:#979892;vertical-align:middle;}.pr-toolbar .pr-toolbar-link{border:2px solid #d7d8d2;color:#979892;display:inline-block;padding:2px 2px;text-decoration:none;text-align:center;min-width:20px;}.pr-toolbar .pr-toolbar-link:hover{border-color:#979892;color:#676862;}.pr-toolbar .pr-toolbar-timer{border:2px solid black;border-radius:10px;background:black;color:white;display:inline-block;float:right;padding:5px 10px;font-family:sans-serif;font-weight:bold;font-size:175%;text-decoration:none;text-align:center;}.pr-container.pr-presenter-mode .pr-slides-area{top:2%;left:2%;height:47.25%;width:48%;}.pr-container.pr-presenter-mode .pr-preview-area{display:block;}.pr-container.pr-presenter-mode .pr-notes-area{display:block;}.pr-container.pr-blackout-mode:not(.pr-presenter-mode) .pr-backdrop{display:block;opacity:0.99;}.pr-container.pr-mirrored-mode:not(.pr-presenter-mode) .pr-slides-area{-webkit-transform:scaleX(-1);-moz-transform:scaleX(-1);-ms-transform:scaleX(-1);-o-transform:scaleX(-1);}@media print{.pr-container{overflow:visible;background-color:#fff;} .pr-container.pr-presenter-mode .pr-slides-area{top:0px;left:0px;height:100%;width:681px;} .pr-container.pr-presenter-mode .pr-preview-area,.pr-container.pr-presenter-mode .pr-notes-area{display:none;} .pr-container.pr-presenter-mode .pr-slide-notes{display:block;margin-left:30px;width:621px;} .pr-slide-container{display:block;position:relative;} .pr-slide-scaler{-moz-box-shadow:none;-webkit-box-shadow:none;box-shadow:none;}}@page {margin:0;}",
  containerLayout: "<div class=\"pr-notes-area\">\n  <div class=\"pr-top-area\">\n    <div class=\"pr-toolbar\">\n      <a class=\"pr-toolbar-link\" href=\"#increase\">+</a>\n      <a class=\"pr-toolbar-link\" href=\"#decrease\">-</a>\n      <span class=\"pr-toolbar-timer\"></span>\n    </div>\n  </div>\n  <div class=\"pr-bottom-area\">\n    <div class=\"pr-notes-current-area\">\n      <div class=\"pr-toggle\">Notes for current slide</div>\n      <div class=\"pr-notes\"></div>\n    </div>\n    <div class=\"pr-notes-preview-area\">\n      <div class=\"pr-toggle\">Notes for next slide</div>\n      <div class=\"pr-notes-preview\"></div>\n    </div>\n  </div>\n</div>\n<div class=\"pr-slides-area\"></div>\n<div class=\"pr-preview-area\"></div>\n<div class=\"pr-backdrop\"></div>\n<div class=\"pr-pause\">\n  <div class=\"pr-pause-lozenge\">\n    <span>Paused</span>\n  </div>\n</div>\n<div class=\"pr-help\">\n  <div class=\"pr-help-content\">\n    <h1>Help</h1>\n    <p><b>Keyboard shortcuts</b></p>\n    <table class=\"light-keys\">\n      <tr>\n        <td>\n          <span class=\"key\"><b>&uarr;</b></span>,\n          <span class=\"key\"><b>&larr;</b></span>,\n          <span class=\"key\">Pg Up</span>,\n          <span class=\"key\">k</span>\n        </td>\n        <td>Go to previous slide</td>\n      </tr>\n      <tr>\n        <td>\n          <span class=\"key\"><b>&darr;</b></span>,\n          <span class=\"key\"><b>&rarr;</b></span>,\n          <span class=\"key\">Pg Dn</span>,\n          <span class=\"key\">Space</span>,\n          <span class=\"key\">j</span>\n        </td>\n        <td>Go to next slide</td>\n      </tr>\n      <tr>\n        <td>\n          <span class=\"key\">Home</span>\n        </td>\n        <td>Go to first slide</td>\n      </tr>\n      <tr>\n        <td>\n          <span class=\"key\">End</span>\n        </td>\n        <td>Go to last slide</td>\n      </tr>\n      <tr>\n        <td>\n          <span class=\"key\">b</span>&nbsp;/\n          <span class=\"key\">m</span>&nbsp;/\n          <span class=\"key\">f</span>\n        </td>\n        <td>Toggle blackout / mirrored / fullscreen mode</td>\n      </tr>\n      <tr>\n        <td>\n          <span class=\"key\">c</span>\n        </td>\n        <td>Clone slideshow</td>\n      </tr>\n      <tr>\n        <td>\n          <span class=\"key\">p</span>\n        </td>\n        <td>Toggle presenter mode</td>\n      </tr>\n      <tr>\n        <td>\n          <span class=\"key\">w</span>\n        </td>\n        <td>Pause/Resume the presentation</td>\n      </tr>\n      <tr>\n        <td>\n          <span class=\"key\">t</span>\n        </td>\n        <td>Restart the presentation timer</td>\n      </tr>\n      <tr>\n        <td>\n          <span class=\"key\">?</span>,\n          <span class=\"key\">h</span>\n        </td>\n        <td>Toggle this help</td>\n      </tr>\n    </table>\n  </div>\n  <div class=\"content dismiss\">\n    <table class=\"light-keys\">\n      <tr>\n        <td>\n          <span class=\"key\">Esc</span>\n        </td>\n        <td>Back to slideshow</td>\n      </tr>\n    </table>\n  </div>\n</div>\n"
};
...
function SlideshowView (events, dom, containerElement, slideshow) {
  ...
  events.on('hideSlide', function (slideIndex) {
    ...
    // the new slide.
    self.elementArea.getElementsByClassName('pr-fading').forEach(function (slide) {
      utils.removeClass(slide, 'pr-fading');
    });
  ...
  events.on('togglePresenterMode', function () {
    utils.toggleClass(self.containerElement, 'pr-presenter-mode');
    self.scaleElements();

    if (utils.hasClass(self.containerElement, 'pr-presenter-mode')) {
  ...
  events.on('toggleHelp', function () {
    utils.toggleClass(self.containerElement, 'pr-help-mode');
  });

  events.on('toggleBlackout', function () {
    utils.toggleClass(self.containerElement, 'pr-blackout-mode');
  });

  events.on('toggleMirrored', function () {
    utils.toggleClass(self.containerElement, 'pr-mirrored-mode');
  });

  events.on('hideOverlay', function () {
    utils.removeClass(self.containerElement, 'pr-blackout-mode');
    utils.removeClass(self.containerElement, 'pr-help-mode');
  });

  events.on('pause', function () {
    utils.toggleClass(self.containerElement, 'pr-pause-mode');
  });
...
SlideshowView.prototype.configureContainerElement = function (element) {
  ...
  utils.addClass(element, 'pr-container');

  if (element === self.dom.getBodyElement()) {
    utils.addClass(self.dom.getHTMLElement(), 'pr-container');
...
SlideshowView.prototype.configureChildElements = function () {
  ...
  self.elementArea = self.containerElement.getElementsByClassName('pr-slides-area')[0];
  self.previewArea = self.containerElement.getElementsByClassName('pr-preview-area')[0];
  self.notesArea = self.containerElement.getElementsByClassName('pr-notes-area')[0];

  self.notesView = new NotesView (self.events, self.notesArea, function () {
    return self.slideViews;
  });

  self.backdropElement = self.containerElement.getElementsByClassName('pr-backdrop')[0];
  self.helpElement = self.containerElement.getElementsByClassName('pr-help')[0];

  self.timerElement = self.notesArea.getElementsByClassName('pr-toolbar-timer')[0];
  self.pauseElement = self.containerElement.getElementsByClassName('pr-pause')[0];
...
},{"components/timer":"9cgzCl","components/printing":"sKNqbK","./slideView":20,"./notesView":21,"../scaler":22,"../resources":6,"../utils":8}],13:[function(require,module,exports){
...
function addLocationEventListeners (events, dom, slideshowView) {
  ...
  function navigateByHash () {
    var slideNoOrName = (dom.getLocationHash() || '').substr(8);
    events.emit('gotoSlide', slideNoOrName);
  }

  function updateHash (slideNoOrName) {
    dom.setLocationHash('#/slide/' + slideNoOrName);
  }
}
...
SlideView.prototype.show = function () {
  utils.addClass(this.containerElement, 'pr-visible');
  utils.removeClass(this.containerElement, 'pr-fading');
};

SlideView.prototype.hide = function () {
  var self = this;
  utils.removeClass(this.containerElement, 'pr-visible');
  ...
  utils.addClass(this.containerElement, 'pr-fading');
  setTimeout(function(){
      utils.removeClass(self.containerElement, 'pr-fading');
  }, 1000);
};
...
SlideView.prototype.configureElements = function () {
  ...
  self.containerElement.className = 'pr-slide-container';

  self.scalingElement = document.createElement('div');
  self.scalingElement.className = 'pr-slide-scaler';

  self.element = document.createElement('div');
  self.element.className = 'pr-slide';
...
function createNotesElement (slideshow, notes) {
  ...
  element.className = 'pr-slide-notes';
...
function setClassFromProperties (element, properties) {
  utils.addClass(element, 'pr-slide-content');
...
function highlightCodeBlocks (content, slideshow) {
  ...
  codeBlocks.forEach(function (block) {
    if (block.parentElement.tagName !== 'PRE') {
      utils.addClass(block, 'pr-inline-code');
      return;
    }
...
function wrapLines (block) {
  var lines = block.innerHTML.split(/\r?\n/).map(function (line) {
    return '<div class="pr-code-line">' + line + '</div>';
  });
...
function highlightBlockLines (block, lines) {
  lines.forEach(function (i) {
    utils.addClass(block.childNodes[i], 'pr-code-line-highlighted');
  });
}

function highlightBlockSpans (block) {
  var pattern = /([^\\`])`([^`]+?)`/g
    , replacement = '$1<span class="pr-code-span-highlighted">$2</span>'
    ;
...
},{"components/slide-number":"7IOt/m","../converter":9,"../highlighter":7,"../utils":8}],21:[function(require,module,exports){
...
NotesView.prototype.configureElements = function () {
  ...
  self.notesElement = self.element.getElementsByClassName('pr-notes')[0];
  self.notesPreviewElement = self.element.getElementsByClassName('pr-notes-preview')[0];
  ...
  self.toolbarElement = self.element.getElementsByClassName('pr-toolbar')[0];
...
},{"./macros":15,"marked":28}],28:[function(require,module,exports){
(function(global){/**
